 ...
 */
final class Version20240921132521 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE university ADD img1 VARCHAR(255) DEFAULT NULL, ADD img2 VARCHAR(255) DEFAULT NULL, ADD img3 VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE university DROP img1, DROP img2, DROP img3');
    }
}
