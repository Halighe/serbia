 ...
 */
final class Version20240830095614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE date date VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program CHANGE date date DATE DEFAULT NULL');
    }
}
