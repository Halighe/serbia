 ...
 */
final class Version20240920120732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE city city VARCHAR(100) DEFAULT NULL, CHANGE adult adult TINYINT(1) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE university ADD img1 VARCHAR(255) DEFAULT NULL, ADD img2 VARCHAR(255) DEFAULT NULL, ADD img3 VARCHAR(255) DEFAULT NULL, DROP img');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE city city VARCHAR(50) DEFAULT NULL, CHANGE adult adult TINYINT(1) DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE university ADD img VARCHAR(256) DEFAULT NULL, DROP img1, DROP img2, DROP img3');
    }
}
