...
const DATA=[
    {
        ...
        answers:[
            {
                id:'0',
                value:'Роботами и технологиями не интересуюсь. Для меня важнее общение с людьми (знакомыми или незнакомыми)',
                correct: true,
            },
            {
                id:'1',
                value:'Роботами и технологиями не интересуюсь. Для меня важнее общение с природой',
                correct: false,
            },
            {
                id:'2',
                value:'Мне нравится работа с техникой, в том числе с компьютерами или различными механизмами',
                correct: false,
            },
            {
                id:'3',
    ...
    const renderWrong1=()=>{
        ...
        <div class="quiz-questions-item">
                    <div class="quiz-questions-item__question">результаты тестирования</div>
                     <p class="info_text">Попробуйте самостоятельно или с помощью профконсультанта изучить содержание профессий представленной сферы и выбрать интересную для вас.</p>
                    <p class="info_text">Для того, чтобы узнать больше о профессиях и вузах, нажмите на кнопку «Карта будущего».</p>
                    <a href="/map" class="lk show"><div>Карта будущего</div></a>
                    <a href="/" class="ek show"><div>Завершить</div></a>
                    </div>
        `;
    ...
    quiz.addEventListener('change',(event)=>{
     if(event.target.classList.contains('answer-input')){
        ...
        const UserName = document.getElementById('us_naming').value;
        const UserMail = document.getElementById('us_mail').value;
